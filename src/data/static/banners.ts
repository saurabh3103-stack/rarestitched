...
export const masonryBanner = [
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/fun2sh_banner.jpg',
        width: 1078,
        height: 425,
      },
    },
...
export const vintageDemoProductBanner = [
  {
    id: 1,
    title: 'Sale Offer',
    slug: 'flash-sale',
...
export const vintageDemoGridBanner = [
  {
    id: 1,
...
export const classicDemoProductBanner = [
  {
    id: 1,
    title: 'Sale Offer',
    slug: 'flash-sale',
